                              ...
                              @csrf
                                ...
                                <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('employee_id') is-invalid @enderror" name="employee_id" id="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('month') is-invalid @enderror" name="month" id="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('year') is-invalid @enderror" name="year" id="">
